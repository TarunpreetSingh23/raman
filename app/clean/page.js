...
export default function CleaningPage() {
  ...
  if (loading) {
    return (
      <p className="text-center mt-20 text-gray-600">Loading services...</p>
    );
  }
    ...
    filteredServices.map((service) => (
      <Link
        ...
        href={`/services/${service.title
          ...
          .replace(/\s+/g, "-")}`}
      >
        <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition overflow-hidden cursor-pointer">
          {/* Image */}
